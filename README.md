...
As one more test we applied denoising to images from [The Street View House Numbers (SVHN) Dataset](http://ufldl.stanford.edu/housenumbers/) and digit classification performance. Again denoising improved performance, this time by 2.5%
